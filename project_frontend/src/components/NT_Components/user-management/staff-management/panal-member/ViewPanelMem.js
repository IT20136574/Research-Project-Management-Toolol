...
export default class ViewPanelMem extends Component {
    constructor(props){
        super(props);
        this.state = {
            fname:"",
    ...
    return (
        ...
        <div class="container">
            ...
            <div class="card mb-2 mt-3" style={{width:94+"%",boxShadow:"0 30px 50px 0 rgba(0,0,0,0.2)"}}>
                <div class="card-body">
                <h4 className="fw-bold mb-1">Panel Member Profile</h4><br/>
                ...
                <div className="col-md-6 mb-2">
                    ...
                    <a href="/panalMember/panal_member"><button className='btn btn-info' style={{width:15+"%"}}>Back</button></a>
                    </div>
                </div>
                </div>
            </div>
